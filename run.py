...
def main():
    ...
    try:
        while True:
            ...
            if switch_state == GPIO.HIGH:  # Switch is not pressed (HIGH state)
                ...
                # Switch is pressed, stop the application
            ...
            # Check if the application has crashed and restart if necessary
